# -*- coding: utf-8 -*-
"""
Created on Thu Jun  2 15:56:12 2022
...
LABELS = ["Bebe_cubierto", "Bebe_descubierto"]

# Leer el modelo
face_mask = cv2.face.LBPHFaceRecognizer_create()
face_mask.read("face_bebe_model.xml")
     ...
     while True:
          ...
          if results.detections is not None:
               for detection in results.detections:
                    ...
                    if result[1] < 150:
                         color = (0, 255, 0) if LABELS[result[0]] == "Bebe_cubierto" else (0, 0, 255)
